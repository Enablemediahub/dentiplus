...
return [
    ...
    'POST' => [
        ...
        '/api/v1/insurance/catalog' => [InsuranceController::class, 'storeCatalog'],
        '/api/v1/insurance/catalog/update' => [InsuranceController::class, 'updateCatalog'],
        '/api/v1/insurance/catalog/delete' => [InsuranceController::class, 'deleteCatalog'],
