...
final class ExpensesController extends Controller
{
    ...
    private function ensureSchema(PDO $pdo): void
    {
        ...
        $this->ensureColumn($pdo, 'expenses', 'detail', 'ALTER TABLE expenses ADD COLUMN detail VARCHAR(255) NOT NULL DEFAULT \'Operational expense\' AFTER id');
        $this->ensureColumn($pdo, 'expenses', 'category', 'ALTER TABLE expenses ADD COLUMN category VARCHAR(100) NOT NULL DEFAULT \'Operations\' AFTER detail');
        $this->ensureColumn($pdo, 'expenses', 'description', 'ALTER TABLE expenses ADD COLUMN description VARCHAR(255) NULL AFTER category');
        $this->ensureColumn($pdo, 'expenses', 'expense_date', 'ALTER TABLE expenses ADD COLUMN expense_date DATE NULL AFTER amount');
        $this->ensureColumn($pdo, 'expenses', 'notes', 'ALTER TABLE expenses ADD COLUMN notes TEXT NULL AFTER expense_date');
        $this->ensureColumn($pdo, 'expenses', 'branch', 'ALTER TABLE expenses ADD COLUMN branch VARCHAR(100) NULL AFTER receptionist_id');
