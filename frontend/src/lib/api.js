...
export const api = {
  ...
  createInsuranceCatalog: (token, body) => request('/insurance/catalog', { method: 'POST', token, body }),
  updateInsuranceCatalog: (token, body) => request('/insurance/catalog/update', { method: 'POST', token, body }),
  deleteInsuranceCatalog: (token, body) => request('/insurance/catalog/delete', { method: 'POST', token, body }),
